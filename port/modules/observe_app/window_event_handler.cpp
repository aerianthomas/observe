...
namespace observe
{
  WindowEventHandler::WindowEventHandler(ApplicationEditor *editor, Frame *frame) : editor_(editor), window_(editor->window()), content_frame_(frame)
  {
  ...
  {
    OBSERVE_ASSERT(width >= 0 && height >= 0);
