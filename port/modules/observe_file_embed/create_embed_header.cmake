...
set(FILE_CONTENTS "${FILE_CONTENTS}  ::observe::EmbeddedFile getFileByName(const std::string& filename);\n")

foreach (FILE ${FILE_LIST})
  string(REGEX MATCH "([^/]+)$" VAR_NAME ${FILE})
  string(REGEX REPLACE "\\.| |-" "_" VAR_NAME ${VAR_NAME})
  set(FILE_CONTENTS "${FILE_CONTENTS}  extern ::observe::EmbeddedFile ${VAR_NAME};\n")
endforeach ()
