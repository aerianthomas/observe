...
function(observe_embed_shaders project include_filename namespace original_shaders)
...
observe_embed_shaders(ObserveEmbeddedShaders "shaders.h" "observe::shaders" "${LIBRARY_SHADERS}")
add_embedded_resources(ObserveEmbeddedFonts "fonts.h" "observe::fonts" "${FONT_TTF_FILES}")
add_embedded_resources(ObserveEmbeddedIcons "icons.h" "observe::icons" "${ICON_FILES}")

add_library(ObserveGraphicsEmbeds INTERFACE)

target_link_libraries(ObserveGraphicsEmbeds
  INTERFACE
  ObserveEmbeddedShaders
  ObserveEmbeddedFonts
  ObserveEmbeddedIcons
)
target_link_libraries(ObserveGraphics PRIVATE ObserveGraphicsEmbeds)

set_target_properties(ObserveEmbeddedShaders PROPERTIES FOLDER "observe")
set_target_properties(ObserveEmbeddedFonts PROPERTIES FOLDER "observe")
set_target_properties(ObserveEmbeddedIcons PROPERTIES FOLDER "observe")
