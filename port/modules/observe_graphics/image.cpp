...
namespace observe
{
  ...
  {
  public:
    explicit ImageAtlasTexture(int width, int height, ImageAtlas::DataType data_type) : width_(width), height_(height), data_type_(data_type) {}
    ...
    {
      OBSERVE_ASSERT(bgfx::isValid(texture_handle_));
