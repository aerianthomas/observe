...
namespace observe
{
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(BlurPostEffect)
  };
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(BloomPostEffect)
  };
  ...
  public:
    ...
    ShaderPostEffect(const EmbeddedFile &vertex_shader, const EmbeddedFile &fragment_shader) : vertex_shader_(vertex_shader), fragment_shader_(fragment_shader) {}
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(ShaderPostEffect)
  };
}