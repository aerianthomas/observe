...
#define OBSERVE_CREATE_BATCH_ID \
  static void *batchId()       \
  {                            \
...
namespace observe
{
  ...
  struct DrawBatch
  {
    DrawBatch(const std::vector<T> *shapes, std::vector<IBounds> *invalid_rects, int x, int y) : shapes(shapes), invalid_rects(invalid_rects), x(x), y(y) {}
  ...
  struct BaseShape
  {
    BaseShape(const void *batch_id, const ClampBounds &clamp, const PackedBrush *brush, float x,
              float y, float width, float height) : batch_id(batch_id), clamp(clamp), brush(brush), x(x), y(y), width(width), height(height) {}
  ...
  struct Primitive : Shape<VertexType>
  {
    ...
    Primitive(const void *batch_id, const ClampBounds &clamp, const PackedBrush *brush, float x,
              float y, float width, float height) : Shape<VertexType>(batch_id, clamp, brush, x, y, width, height) {}
  ...
  struct RoundedRectangle : Primitive<>
  {
    ...
    RoundedRectangle(const ClampBounds &clamp, const PackedBrush *brush, float x, float y,
                     float width, float height, float rounding, float pixel_width = 1.0f) : Primitive(batchId(), clamp, brush, x, y, width, height), rounding(rounding)
    {
  ...
  struct Circle : Primitive<>
  {
    ...
    Circle(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width) : Primitive(batchId(), clamp, brush, x, y, width, width) {}
  ...
  struct Squircle : Primitive<>
  {
    ...
    Squircle(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
             float height, float power) : Primitive(batchId(), clamp, brush, x, y, width, height), power(power) {}
  ...
  struct FlatArc : Primitive<>
  {
    ...
    FlatArc(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
            float height, float thickness, float center_radians, float radians) : Primitive(batchId(), clamp, brush, x, y, width, height), center_radians(center_radians),
                                                                                  radians(radians)
    {
  ...
  struct FlatSegment : Primitive<ComplexShapeVertex>
  {
    ...
    FlatSegment(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                ...
                float pixel_width) : Primitive(batchId(), clamp, brush, x, y, width, height), a_x(a_x), a_y(a_y), b_x(b_x), b_y(b_y)
    {
      this->thickness = thickness;
      this->pixel_width = pixel_width;
    }
  ...
  struct RoundedSegment : Primitive<ComplexShapeVertex>
  {
    ...
    RoundedSegment(const ClampBounds &clamp, const PackedBrush *brush, float x, float y,
                   ...
                   float thickness, float pixel_width) : Primitive(batchId(), clamp, brush, x, y, width, height), a_x(a_x), a_y(a_y), b_x(b_x), b_y(b_y)
    {
      this->thickness = thickness;
      this->pixel_width = pixel_width;
    }
  ...
  struct Triangle : Primitive<ComplexShapeVertex>
  {
    ...
    Triangle(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
             ...
             float rounding, float thickness) : Primitive(batchId(), clamp, brush, x, y, width, height), a_x(a_x), a_y(a_y), b_x(b_x),
  ...
  struct QuadraticBezier : Primitive<ComplexShapeVertex>
  {
    ...
    QuadraticBezier(const ClampBounds &clamp, const PackedBrush *brush, float x, float y,
                    float width, float height, float a_x, float a_y, float b_x, float b_y,
                    float c_x, float c_y, float thickness, float pixel_width) : Primitive(batchId(), clamp, brush, x, y, width, height), a_x(a_x), a_y(a_y), b_x(b_x),
                                                                                b_y(b_y), c_x(c_x), c_y(c_y)
    {
      this->thickness = thickness;
      this->pixel_width = pixel_width;
  ...
  struct Diamond : Primitive<>
  {
    ...
    Diamond(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
            float height, float rounding) : Primitive(batchId(), clamp, brush, x, y, width, height), rounding(rounding) {}
  ...
  struct ImageWrapper : Shape<TextureVertex>
  {
    ...
    ImageWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                 float height, const Image &image, ImageAtlas *image_atlas) : Shape(image_atlas, clamp, brush, x, y, width, height),
  ...
  struct GraphLineWrapper : Primitive<>
  {
    ...
    GraphLineWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                     float height, float thick, const GraphData &graph_data, ImageAtlas *data_atlas) : Primitive(data_atlas, clamp, brush, x, y, width, height), data_atlas(data_atlas),
  ...
  struct GraphFillWrapper : Primitive<>
  {
    ...
    GraphFillWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                     float height, float center, const GraphData &graph_data, ImageAtlas *data_atlas) : Primitive(taggedPointer(data_atlas, 1), clamp, brush, x, y, width, height),
  ...
  struct HeatMapWrapper : Primitive<>
  {
    ...
    HeatMapWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                   float height, const HeatMapData &heat_map_data, ImageAtlas *data_atlas) : Primitive(taggedPointer(data_atlas, 2), clamp, brush, x, y, width, height),
  ...
  struct PathFillWrapper : Shape<TextureVertex>
  {
    ...
    PathFillWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y,
                    float width, float height, const Path &path, PathAtlas *atlas, float scale) : Shape(batchId(), clamp, brush, x, y, width, height), path_atlas(atlas), scale(scale)
    {
  ...
  struct TextBlock : Shape<TextureVertex>
  {
    TextBlock(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
              float height, Text *text, const Font &font, Direction direction) : Shape(font.packedFont(), clamp, brush, x, y, width, height),
  ...
  struct ShaderWrapper : Shape<>
  {
    ShaderWrapper(const ClampBounds &clamp, const PackedBrush *brush, float x, float y, float width,
                  float height, Shader *shader) : Shape(shader, clamp, brush, x, y, width, height), shader(shader) {}
