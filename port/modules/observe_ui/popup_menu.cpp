...
namespace observe
{
  OBSERVE_THEME_COLOR(PopupMenuBackground, 0xff262a2e);
  OBSERVE_THEME_COLOR(PopupMenuBorder, 0xff606265);
  OBSERVE_THEME_COLOR(PopupMenuText, 0xffeeeeee);
  OBSERVE_THEME_COLOR(PopupMenuDisabledText, 0xff888888);
  OBSERVE_THEME_COLOR(PopupMenuSelection, 0xffaa88ff);
  OBSERVE_THEME_COLOR(PopupMenuSelectionText, 0xffffffff);

  OBSERVE_THEME_VALUE(PopupOptionHeight, 22.0f);
  OBSERVE_THEME_VALUE(PopupMinWidth, 175.0f);
  OBSERVE_THEME_VALUE(PopupTextPadding, 9.0f);
  OBSERVE_THEME_VALUE(PopupFontSize, 14.0f);
  OBSERVE_THEME_VALUE(PopupSelectionPadding, 4.0f);
  ...
  PopupMenuFrame::PopupMenuFrame(PopupMenu menu) : menu_(std::move(menu)), font_(10, fonts::Lato_Regular_ttf)
  {
