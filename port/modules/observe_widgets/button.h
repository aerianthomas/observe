...
#include "modules/observe_graphics/svg.h"
#include "modules/observe_graphics/text.h"
#include "modules/observe_graphics/theme.h"
#include "modules/observe_ui/frame.h"
#include "modules/observe_ui/svg_frame.h"
...
namespace observe
{
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(Button)
  };

  class UiButton : public Button
  {
  public:
    OBSERVE_THEME_DEFINE_COLOR(UiButtonBackground);
    OBSERVE_THEME_DEFINE_COLOR(UiButtonBackgroundHover);
    OBSERVE_THEME_DEFINE_COLOR(UiButtonText);
    OBSERVE_THEME_DEFINE_COLOR(UiButtonTextHover);

    OBSERVE_THEME_DEFINE_COLOR(UiActionButtonBackground);
    OBSERVE_THEME_DEFINE_COLOR(UiActionButtonBackgroundHover);
    OBSERVE_THEME_DEFINE_COLOR(UiActionButtonText);
    OBSERVE_THEME_DEFINE_COLOR(UiActionButtonTextHover);
  ...
  {
  public:
    OBSERVE_THEME_DEFINE_COLOR(ToggleButtonDisabled);
    OBSERVE_THEME_DEFINE_COLOR(ToggleButtonOff);
    OBSERVE_THEME_DEFINE_COLOR(ToggleButtonOffHover);
    OBSERVE_THEME_DEFINE_COLOR(ToggleButtonOn);
    OBSERVE_THEME_DEFINE_COLOR(ToggleButtonOnHover);
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(ToggleButton)
  };
  ...
  public:
    ...
    ToggleIconButton(const std::string &name, const Svg &icon, bool shadow = false) : ToggleButton(name)
    {
      setIcon(icon);
      initSettings(shadow);
    }
