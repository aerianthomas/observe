...
namespace observe
{
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorBackground, 0xff2c3033);
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorBorder, 0);
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorText, 0xffeeeeee);
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorDefaultText, 0xff848789);
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorCaret, 0xffffffff);
  OBSERVE_THEME_IMPLEMENT_COLOR(TextEditor, TextEditorSelection, 0x22ffffff);

  OBSERVE_THEME_IMPLEMENT_VALUE(TextEditor, TextEditorRounding, 5.0f);
  OBSERVE_THEME_IMPLEMENT_VALUE(TextEditor, TextEditorMarginX, 9.0f);
  OBSERVE_THEME_IMPLEMENT_VALUE(TextEditor, TextEditorMarginY, 9.0f);
