...
#include "modules/observe_ui/scroll_bar.h"
...
namespace observe
{
  ...
  public:
    ...
    OBSERVE_THEME_DEFINE_COLOR(TextEditorBackground);
    OBSERVE_THEME_DEFINE_COLOR(TextEditorBorder);
    OBSERVE_THEME_DEFINE_COLOR(TextEditorText);
    OBSERVE_THEME_DEFINE_COLOR(TextEditorDefaultText);
    OBSERVE_THEME_DEFINE_COLOR(TextEditorCaret);
    OBSERVE_THEME_DEFINE_COLOR(TextEditorSelection);

    OBSERVE_THEME_DEFINE_VALUE(TextEditorRounding);
    OBSERVE_THEME_DEFINE_VALUE(TextEditorMarginX);
    OBSERVE_THEME_DEFINE_VALUE(TextEditorMarginY);
  ...
  private:
    ...
    OBSERVE_LEAK_CHECKER(TextEditor)
  };
}