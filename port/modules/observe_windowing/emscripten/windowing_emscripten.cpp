...
#include "observe_utils/string_utils.h"
...
{
  observe::clipboard_text_ = text;
  observe::WindowEmscripten::runningInstance()->handleKeyDown(observe::KeyCode::V,
                                                             observe::Modifiers::kModifierRegCtrl, 0);
}
...
namespace observe
{
  ...
  WindowEmscripten::WindowEmscripten(int width, int height) : Window(width, height), initial_width_(width), initial_height_(height)
  {
